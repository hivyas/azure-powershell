...
```
Update-AzADB2CTenant -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String>]
 [-BillingType <BillingType>] [-SkuName <B2CResourceSkuname>] [-Tag <Hashtable>] [-TenantId <String>]
...
Update-AzADB2CTenant -InputObject <IActiveDirectoryB2CIdentity> [-BillingType <BillingType>]
 [-SkuName <B2CResourceSkuname>] [-Tag <Hashtable>] [-TenantId <String>] [-DefaultProfile <PSObject>]
