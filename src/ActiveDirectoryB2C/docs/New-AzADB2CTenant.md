...
online version: https://docs.microsoft.com/en-us/powershell/module/az.activedirectoryb2c/new-azadb2ctenant
schema: 2.0.0
---
...
```
New-AzADB2CTenant -ResourceGroupName <String> -ResourceName <String> -CountryCode <String>
 -DisplayName <String> -Location <String> -SkuName <B2CResourceSkuname> [-SubscriptionId <String>]
